...
const timerBtn1 = document.querySelector("#btn1");
const timerBtn2 = document.querySelector("#btn2");
const timerBtn3 = document.querySelector("#btn3");
...
function btn1Game(){
    // alert("you have started 15sec test");

    displayText.textContent = "you have choosen 15sec test."
...
function btn2Game(){
    displayText.textContent = "you have choosen 30sec test."
    displayText.style.color = "green"
    console.log(displayText);}

function btn3Game(){
    displayText.textContent = "you have choosen 60sec test."
    displayText.style.color = "green"
    console.log(displayText);}
...
// timerBtn me event listener 

timerBtn1.addEventListener('click', btn1Game);
timerBtn2.addEventListener('click', btn2Game);
timerBtn3.addEventListener('click', btn3Game);